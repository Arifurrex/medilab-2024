            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="./index.html"><img src="{{asset('img/MediLabLogo.png')}}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <section class="hero hero-normal">
        <div class="container">
            <div class="row">
                ...
                <!-- category for samll device -->
                <div class="col-lg-3  hero__category__small-device">
                    <div x-data="{ isOpen: false, openIndex: -1}" class="hero__categories">
                        ...
                        <ul>
                            ...
                            <li @click="openIndex === {{ $index }} ?  openIndex = -1 : openIndex = {{ $index }} "><a href="#">{{$category->name}}</a>
                                <ul class="subCategory"
                                    ...
                                    <li class=" subCategory--list"><a href="">{{$subcategory->name}}</a>
                                    </li>
                                    @endforeach
                                </ul>
                            </li>
                ...
                <!-- category for large device -->
                <div class="col-lg-3 hero__category__large-device">
                    <div x-data="{ isOpen: false, openIndex: -1}" class="hero__categories">
                        <div class="hero__categories__all">
                            <i class="fa fa-bars"></i>
                            <span>All departments</span>
